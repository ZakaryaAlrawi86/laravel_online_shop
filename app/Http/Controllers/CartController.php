...
class CartController extends Controller
{
    ...
    public function applyDiscount(Request $request)
    {
        ...
        if ($code == null) {
            return response()->json([
                'status' => false,
                'message' => 'Invalid discount  coupon because not found',
            ]);
        }
        ...
        if ($code->starts_at != "") {
            ...
            if ($now->lt($startDate)) {
                return response()->json([
                    'status' => false,
                    'message' => 'Invalid discount coupon less than current date',
                ]);
            }
        }
        ...
        if ($code->expires_at != "") {
            ...
            if ($now->gt($endDate)) {
                return response()->json([
                    'status' => false,
                    'message' => 'Invalid discount coupon greater than current date',
                ]);
            }
        }
        //Max Uses Check
