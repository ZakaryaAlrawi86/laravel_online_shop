            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                                ...
                                @foreach ($productImages as $image)
                                    <div class="col-md-3" id="image-row-{{ $image->id }}">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <a href="gavascript:void(0)" onclick="deleteImage({{ $image->id }})"
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <h2 class="h4 mb3">Related products</h2>
                                <div class="mb-3">
        ...
        const dropzone = $("#image").dropzone({
            ...
            success: function(file, response) {
                ...
                var html = `<div class="col-md-3" id="image-row-${response.image_id}"><div class="card">
                    ...
                    <div class="card-body">
                        <a href="gavascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Delete</a>
                    </div>
                </div></div>`;
